  ...
  return (
    <SectionCard className="mx-auto max-w-6xl px-3 sm:px-4 w-full">
      <div className="space-y-8">
        <div>
          <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-6">Quiénes somos</h2>
        ...
        <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-lg p-6 md:p-8 border border-emerald-200 dark:border-emerald-800">
          <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-6">Pilares de nuestro servicio</h3>
          <ul className="space-y-3">
            <li className="flex gap-3 text-sm md:text-base text-slate-700 dark:text-slate-300">
        ...
        <div>
          <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-4">Nuestra solución</h3>
          <p className="text-sm md:text-base text-slate-700 dark:text-slate-300 mb-6">
          ...
          <h4 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-4">¿Qué hacemos por vos?</h4>
          <ul className="space-y-3">
            <li className="flex gap-3 text-sm md:text-base text-slate-700 dark:text-slate-300">
